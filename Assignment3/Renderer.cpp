...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	static auto X1 = gui_1->addVariable("Rotate X1", m_bone_animation->rotation_degree_vector[1][0]);
	static auto Y1 = gui_1->addVariable("Rotate Y1", m_bone_animation->rotation_degree_vector[1][1]);
	static auto Z1 = gui_1->addVariable("Rotate Z1", m_bone_animation->rotation_degree_vector[1][2]);
	static auto X2 = gui_1->addVariable("Rotate X2", m_bone_animation->rotation_degree_vector[2][0]);
	static auto Y2 = gui_1->addVariable("Rotate Y2", m_bone_animation->rotation_degree_vector[2][1]);
	static auto Z2 = gui_1->addVariable("Rotate Z2", m_bone_animation->rotation_degree_vector[2][2]);
	static auto X3 = gui_1->addVariable("Rotate X3", m_bone_animation->rotation_degree_vector[3][0]);
	static auto Y3 = gui_1->addVariable("Rotate Y3", m_bone_animation->rotation_degree_vector[3][1]);
	static auto Z3 = gui_1->addVariable("Rotate Z3", m_bone_animation->rotation_degree_vector[3][2]);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	//Yellow
	glm::mat4 yellow = m_bone_animation->yellowRotate(root_bone_obj_mat);
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(yellow));
	bone_obj->obj_color = m_bone_animation->colors[1];
	draw_object(shader, *bone_obj);
	//Magenta
	glm::mat4 magenta = m_bone_animation->magentaRotate(m_bone_animation->yellow_bone);
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(magenta));
	bone_obj->obj_color = m_bone_animation->colors[2];
	draw_object(shader, *bone_obj);
	//Cyan
	glm::mat4 cyan = m_bone_animation->cyanRotate(m_bone_animation->magenta_bone);
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(cyan));
